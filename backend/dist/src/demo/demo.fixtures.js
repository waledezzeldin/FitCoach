...
exports.availableDemoPersonas = exports.getDemoFixture = void 0;
const sharedStats = {
...
const getDemoFixture = (persona) => {
    const key = (persona?.toLowerCase?.() ?? 'user');
    return baseFixtures[key] ?? baseFixtures.user;
};
exports.getDemoFixture = getDemoFixture;
exports.availableDemoPersonas = Object.keys(baseFixtures);
//# sourceMappingURL=demo.fixtures.js.map