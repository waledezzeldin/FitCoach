...
exports.getAlternativesForInjury = void 0;
const SHOULDER_ALTERNATIVES = [
    {
...
const getAlternativesForInjury = (injuryArea, muscleGroup) => {
    const key = injuryArea;
    const base = MAP[key] ?? [];
    if (!muscleGroup) {
        return base;
    }
...
exports.getAlternativesForInjury = getAlternativesForInjury;
//# sourceMappingURL=injury-map.js.map