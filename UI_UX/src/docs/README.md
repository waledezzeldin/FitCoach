# عاش (FitCoach+ v2.0) - Complete Documentation Package

## 📋 Documentation Overview

This directory contains comprehensive SDLC (Software Development Life Cycle) documentation for **عاش** (FitCoach+), a bilingual (English/Arabic) fitness coaching platform. The documentation is organized by development phases and is designed to be **platform-agnostic** and suitable for migration to any programming language or framework.

**🆕 NEW STRUCTURE**: Documentation is now organized by SDLC phases for better navigation:
- **Phase 1**: Customer Requirements (user needs and features)
- **Phase 2**: Software Requirements (technical specifications)  
- **Phase 3**: Software Architecture (system design)
- **Phase 4**: Code Documentation (implementation details)

📚 **[VIEW COMPLETE DOCUMENTATION INDEX →](./INDEX.md)**

---

## 🗂️ SDLC-Based Organization

### Phase 1: Customer Requirements
📁 **[1-customer-requirements/](./1-customer-requirements/README.md)**

Define WHAT users need from their perspective:
- [End User Requirements](./1-customer-requirements/end-user-requirements.md) - Features for fitness enthusiasts (15,000 words)
- [Coach Requirements](./1-customer-requirements/coach-requirements.md) - Coaching tools and features (8,000 words)
- [Admin Requirements](./1-customer-requirements/admin-requirements.md) - Platform management (10,000 words)

### Phase 2: Software Requirements  
📁 **[2-software-requirements/](./2-software-requirements/README.md)**

Translate customer needs into technical specs:
- Functional requirements (system behaviors)
- Non-functional requirements (performance, security)
- Data requirements (schemas, models)
- API requirements (endpoints, contracts)

**Existing comprehensive documentation**:
- [02-DATA-MODELS.md](./02-DATA-MODELS.md) - Complete database schema (8,000 words)
- [04-FEATURE-SPECIFICATIONS.md](./04-FEATURE-SPECIFICATIONS.md) - v2.0 feature deep-dive (12,000 words)
- [05-BUSINESS-LOGIC.md](./05-BUSINESS-LOGIC.md) - Algorithms and calculations (10,000 words)
- [06-API-SPECIFICATIONS.md](./06-API-SPECIFICATIONS.md) - API contracts (7,000 words)

### Phase 3: Software Architecture
📁 **[3-software-architecture/](./3-software-architecture/README.md)**
...
**Existing comprehensive documentation**:
- [01-EXECUTIVE-SUMMARY.md](./01-EXECUTIVE-SUMMARY.md) - Project overview and architecture (5,000 words)
- [03-SCREEN-SPECIFICATIONS.md](./03-SCREEN-SPECIFICATIONS.md) - UI/UX for all screens (15,000 words)

### Phase 4: Code Documentation
📁 **[4-code-documentation/](./4-code-documentation/README.md)**

Document implementation details:
- Component documentation (screens, UI components)
- Utility functions (injuryRules, quotaEnforcement, nutritionExpiry)
...
**Purpose**: Detailed API contracts and endpoints  
...
- **Rating API**
  - Coach rating submission
  - Trainer rating submission
  - Rating retrieval
...
- **Progress Tracking API**
  - Weight entry submission
  - InBody scan submission
  - Progress report retrieval

**Use this** to implement and test API endpoints for the platform.
